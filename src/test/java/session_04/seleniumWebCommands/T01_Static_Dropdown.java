...
//    Don't apply Thread.sleep -> it is for you to see the execution ; remove it once you learn the script's purpose
 ...
 Select selectfromdropdon = new Select(driver.findElement(By.id("dropdown")));

        //3- Select options using 3 methods

        //3.1- SelectByIndex

        selectfromdropdon.selectByIndex(1);
Thread.sleep(3000);
        //3.2- SelectByValue
        selectfromdropdon.selectByValue("2");
        //Note SelectByValue input value is String but SelectByIndex is Integer

        Thread.sleep(3000);
        //3.3- SelectByVisibleText
        selectfromdropdon.selectByVisibleText("Option 2");
        Thread.sleep(3000);
        driver.quit();
    }
